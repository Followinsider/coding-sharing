				...
				<div class="col-4 d-flex justify-content-end align-items-center">
					<div class="create_login">
						<el-dropdown split-button type="primary" @click="toEdit">
							创作者中心
							<el-dropdown-menu>
								<el-dropdown-item @click.native="toHome">我的中心</el-dropdown-item>
								<el-dropdown-item @click.native="toHelp">提问</el-dropdown-item>
							</el-dropdown-menu>
						</el-dropdown>
						...
						<el-dropdown @command="handleCommand">
							<el-avatar src="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png"
								v-show="isLogin" class="avatar"></el-avatar>
